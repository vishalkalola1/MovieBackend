...
public abstract class GenericDAO<T, I> {
	...
	public List<T> authenticate(I columnName, I id,I passwordcolumnName,  I password) {
		String query = "from " + getClassName() + " where " + columnName + " = '" + id + "' AND " + passwordcolumnName + " = '" + password +"'";
		return em.createQuery(query,getEntityClass()).getResultList();
	}
